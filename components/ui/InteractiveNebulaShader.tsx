 ...
 * Optimized for performance: pauses when off-screen, capped pixel ratio.
 */
export function InteractiveNebulaShader({
  ...
  useEffect(() => {
    ...
    // Performance Optimization: Cap pixel ratio to 1.5 to save battery/GPU on high-DPI mobile devices
    ...
    const fragmentShader = `
      ...
      void mainImage(out vec4 O, in vec2 fragCoord) {
        ...
        // Ray-march
        // Optimization: Reduced iterations for mobile performance
        for (int i = 0; i <= 4; i++) {
    ...
    const onResize = () => {
      ...
      uniforms.iResolution.value.set(w * pixelRatio, h * pixelRatio); // Adjust uniform for pixel ratio
    };
